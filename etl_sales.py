...
def transform(customers, products, orders):
    """Clean and join data to produce sales_clean and country_summary."""
    # Clean customers
    ...
    # Final clean table (exact column order)
    sales_clean = sales[
        [
            "order_id",
            "order_date",
    ...
    return sales_clean, country_summary


def load(sales_clean, country_summary):
    """Export transformed results to CSV."""
...
def main():
    ...
    sales_clean, country_summary = transform(customers, products, orders)
    load(sales_clean, country_summary)
